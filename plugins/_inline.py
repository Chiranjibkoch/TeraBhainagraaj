...
SUP_BUTTONS = [
    [
        ...
        Button.url("• Support •", url="t.me/VipFreinds"),
    ],
]
...
async def inline_alive(o):
    TLINK = inline_pic() or "https://telegra.ph//file/149f1ca05ec917b07820b.jpg"
    MSG = "• **Sakil Userbot •**"
    WEB0 = InputWebDocument(
        "https://telegra.ph//file/149f1ca05ec917b07820b.jpg", 0, "image/jpg", []
    )
    RES = [
...
async def inline_handler(event):
    ...
    if inline_pic():
        ...
        result = await event.builder.article(
            title="Sakil Help Menu", text=text, buttons=_main_help_menu
        )
...
async def ibuild(e):
    ...
    if pic:
        try:
            ...
            LOGS.exception(er)
    result = [
        await builder.article("Sakil Op", text=txt, link_preview=False, buttons=btn)
    ]
