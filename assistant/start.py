...
**Sakil [v{ultroid_version}](https://github.com/TeamUltroid/Ultroid), powered by @VipFreinds**
"""
...
async def ultroid(event):
    ...
    if event.sender_id not in SUDO_M.fullsudos:
        ...
        if not udB.get_key("STARTMSG"):
            ...
            await event.reply(
                f"Hey there {mention}, this is Sakil Assistant of {me}!\n\n{ok}",
